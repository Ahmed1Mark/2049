    ...
    try {
        ...
        setTimeout(async () => {
            ...
            const embed = new MessageEmbed()
                ...
                .addFields(
                    { name: 'Ticket Creator', value: `\`?????\``, inline: true },
                    { name: 'Ticket Closed By', value: `${mention}`, inline: true },
                    { name: 'Ticket Claimed By', value: `\`?????\``, inline: true },
                    { name: 'Ticket Name', value: `\`${ticketName}\``, inline: true },
                    { name: 'Ticket Department', value: `\`?????\``, inline: true },
                    { name: 'Ticket Closed Date', value: `**\`${saveticketdate2},${saveticketdate}\`**`, inline: true }
                )
            ...
            await destinationChannel.send({ embeds: [embed], files: [attachment] });
...
const embedopen1 = new MessageEmbed()
    ...
    .setAuthor({ name: `Welcome To Bot ${member.client.user.username}`, iconURL: member.client.user.displayAvatarURL({ format: 'png', dynamic: true, size: 1024 }) })
    .setColor('#1c1c24')
    .addFields(
